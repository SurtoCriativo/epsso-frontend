export const outsourcedManagementConstants = [
  {
    heading: "Para seus Colaboradores",
    content:
      "Gestão de Ambulatório Médico /Ambulatório de Enfermagem (NR 4 Portaria 3.214/ 78)\n" +
  ...
  {
    heading: "Terceirização de Técnicos em Segurança do Trabalho",
    content:
      "\u00A0 \u00A0• Oferecimento de Profissionais com experiência e certificação de acordo com necessidades da sua empresa\n" +
