    ...
    <main className="px-0 w-full mx-auto">
      ...
      <QuoteSection>
        <p className="text-brand-400 font-medium mx-auto w-[372px] sm:w-[723px] text-[16px] md:text-[32px]">
          Para manter a produtividade em alta,
        </p>
        <p className="text-brand-400 font-medium mx-auto w-[372px] sm:w-[723px] text-[16px] md:text-[32px]">
          é preciso garantir o bem-estar da equipe
        </p>
      </QuoteSection>
      <ErgonomySection />
            ...
            >
              ...
              >
                ...
                <Accordion.Heading
                  ...
                  index={i + 1}
                >
                  <h3 className="flex-1 font-medium sm:font-mediumd">
                    {item.heading}
                  </h3>
                </Accordion.Heading>
