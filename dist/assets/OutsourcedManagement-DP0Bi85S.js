import{j as e,m as v,r as t}from"./index-BzGYe7f0.js";import{Q as w}from"./QuoteSection-D2aeZrNv.js";import{C}from"./ContactForm-2wysNk-O.js";import{T as N,A as d}from"./Tooltip-Dlxep4Me.js";import{u as E}from"./useHtmlMetaData-sM3IHEN1.js";import"./useEmail-CPEsA6wt.js";import"./useContactForm-Bdf8LTH0.js";import"./formatters-DEC8jTlI.js";function T(){return e.jsx(v.section,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.6,ease:"easeOut"},className:`\r
        w-full bg-white\r
        py-6 md:py-[120px]\r
        px-4 md:px-0\r
...
`}],z=[{id:1,top:"67%",left:"18%",text:"Terceirização de Técnicos em Segurança do Trabalho",position:"right",accordionIndex:2},{id:2,top:"38%",left:"43%",text:"Para seus Clientes",position:"right",accordionIndex:1},{id:3,top:"52%",left:"75%",text:"Para seus Colaboradores",position:"right",accordionIndex:0}];function k(){const[p,l]=t.useState(null),[f,g]=t.useState(null),h=t.useRef(!1);E({title:"EPSSO | Gestão de Terceirizados",metaDescription:"Contratar serviços de outsourcing e terceirização é uma estratégia eficiente que reduz custos, garante conformidade legal e permite que sua empresa concentre esforços no foco principal da empresa - enquanto a segurança e medicina do trabalho ficam por conta da EPSSO."});const[r,m]=t.useState(null),i=t.useRef([]),b=t.useCallback(a=>{h.current=!0,g(null),l(a)},[]),S=t.useCallback(()=>{l(null)},[]),j=t.useCallback(a=>{if(a.accordionIndex!==void 0){const o=i.current[a.accordionIndex];if(o){const s=o.querySelector('[role="button"]'),u=r===a.accordionIndex;if(r!==null&&r!==a.accordionIndex){const n=i.current[r];if(n){const c=n.querySelector('[role="button"]');c&&c.getAttribute("aria-expanded")==="true"&&c.click()}}!u&&s&&s.click(),setTimeout(()=>{const n=i.current[a.accordionIndex];if(n){const x=n.getBoundingClientRect().top+window.pageYOffset+-97;window.scrollTo({top:x,behavior:"smooth"})}},u?0:300)}}},[r]);return e.jsxs("main",{className:"px-0 w-full mx-auto",children:[e.jsxs(w,{children:[e.jsx("p",{className:"text-brand-400 font-medium mx-auto w-[372px] sm:w-[723px] text-[16px] md:text-[32px]",children:"Com soluções em outsourcing e terceirização,"}),e.jsx("p",{className:"text-brand-400 font-medium mx-auto w-[372px] sm:w-[723px] text-[16px] md:text-[32px]",children:"sua empresa ganha em eficiência e economia"})]}),e.jsx(T,{}),e.jsxs("section",{className:"relative w-full max-w-[1128px] mx-auto",children:[e.jsx("h1",{className:"mx-auto max-w-[343px] md:pt-0 md:max-w-[1128px] text-center text-[20px] pt-4 md:text-left md:text-[24px] font-medium text-2xl text-green-accents-400",children:"Conheça nossas soluções em Gestão de Serviços Terceirizados:"}),e.jsx("p",{className:"text-center md:text-left text-[16px] md:text-[18px] text-neutral-700 pb-[40px]",children:"Veja todas nossas soluções abaixo da imagem."}),e.jsx("img",{src:"/interactive/interactive-outsourced.webp",alt:"Industrial Safety Overview",className:"w-full max-h-auto object-cover rounded-3xl pb-[80px]"}),z.map(a=>e.jsx("div",{className:"hidden md:block md:absolute",style:{top:a.top,left:a.left},onMouseEnter:()=>b(a.id),onMouseLeave:S,children:e.jsx(N,{isVisible:p===a.id||f===a.id,text:a.text,position:a.position,children:e.jsx("button",{onClick:()=>j(a),className:"ripple-animation cursor-pointer w-6 h-6 border-brand-300 border-2 bg-green-accents-400 rounded-full flex items-center justify-center text-white font-bold shadow-md hover:bg-green-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"})})},a.id))]}),e.jsx("div",{className:"w-full max-w-[1128px] pb-[80px] mx-auto px-4 sm:px-0",children:e.jsx("div",{className:"flex flex-col gap-6",children:O.map((a,o)=>e.jsx("div",{ref:s=>{i.current[o]=s},children:e.jsxs(d,{defaultOpen:!1,onToggle:s=>{s?m(o):r===o&&m(null)},children:[e.jsx(d.Heading,{className:"max-h-[36px] sm:max-h-[40px]",index:o+1,children:e.jsx("h3",{className:"flex-1 font-medium sm:font-medium",children:a.heading})}),e.jsx(d.Content,{className:"whitespace-pre-line",children:a.content})]})},o))})}),e.jsx(C,{preSelectedSolution:"gestao-de-terceirizados",pageSource:"Gestão de Terceirizados",successMessage:"Obrigado pelo seu interesse por soluções em Gestão de Terceirizados."})]})}export{k as default};
